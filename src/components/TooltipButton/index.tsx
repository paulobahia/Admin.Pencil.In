...
export const TooltipButton: React.FC<TooltipButtonProps> = ({ description, variant = 'default', icon }) => {
    ...
    <TooltipProvider>
      <Tooltip delayDuration={300}>
        <TooltipTrigger asChild>
          <Button size={'icon'} variant={'outline'} className={variantClasses[variant]}>
            {icon}
          </Button>
        </TooltipTrigger>
